 ...
 *
 */
package net.mcreator.lesthonsrouges;
...
@Mod("les_thons_rouges")
public class LesThonsRougesMod {
	public static final Logger LOGGER = LogManager.getLogger(LesThonsRougesMod.class);
	public static final String MODID = "les_thons_rouges";
